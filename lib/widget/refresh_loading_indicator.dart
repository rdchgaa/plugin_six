...
class RefreshLoadingIndicatorState extends State<RefreshLoadingIndicator> with TickerProviderStateMixin<RefreshLoadingIndicator> {
  ...
  void _show() {
    ...
    _positionController?.animateTo(1.0 / _kDragSizeFactorLimit, duration: _kIndicatorSnapDuration).then<void>((void
    value) {
        ...
        if (_mode != null)
          Positioned(
            ...
            child: SizeTransition(
              ...
              child: Container(
                padding: _isIndicatorAtTop! ? EdgeInsets.only(top: widget.displacement) : EdgeInsets.only(bottom:
                widget.displacement),
